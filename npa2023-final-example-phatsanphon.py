...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    if message.find("/phatsanphon") == 0:
        ...
        location = message.replace('/phatsanphon', '').strip()
...
# 6. Provide the URL to the OpenWeather Geocoding address API.
        ...
        print("Received location data: " + str(json_data))
#######################################################################################
...
# 11. Complete the code to format the response message.
        ...
        responseMessage = f"In {location} (latitude: {locationLat}, longitute: {locationLng}), the current weather is {weather_desc} and the temperature is {weather_temp:.2f} degree celsius.\n"
